...
public class MainActivity2_Hacker extends AppCompatActivity {
    ...
    int score = 300, count = 3, len, blanks_filled = 0, k = 0, rows, columns, product, no_words,size,m=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity2_main_hacker);
        ...
        for (int i = 0; i < product; i++) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (k == len) {
                        Toast.makeText(MainActivity2_Hacker.this, "You've entered maximum no. of letters!", Toast.LENGTH_SHORT).show();
